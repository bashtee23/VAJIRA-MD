...
global.owner = process.env.OWNER_NUMBER  || '2347043367083' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=6MUiWZLY#dYVZKO16DUnVCOtfeh7Wnhf22Yg9EJHfA_QCtVi8yGs' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2347043367083,2347043367083" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'BASHTECH' ,
